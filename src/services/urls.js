...
const urlService = (endpoint) => {
    ...
    switch(endpoint) {
        ...
        break;
        case endpoints.GetBusinessList:
        url = production ===  true ? `${urls.PRODUCTION_API_URL}/${endpoints.GetBusinessList}`
                                    : `${urls.LOCAL_API_URL}/${endpoints.GetBusinessList}`;
        break;
        case endpoints.GetBusinessLocationSearch:
